package com.autosys.generator.util;

import com.autosys.common.core.util.StringUtils;
import com.autosys.generator.config.GeneratorConfig;
...
public class GeneratorUtils
{
    ...
    public static void initTable(GenTable genTable, String operName)
    {
        ...
        genTable.setPackageName(GeneratorConfig.getPackageName());
        genTable.setModuleName(getModuleName(GeneratorConfig.getPackageName()));
        genTable.setBusinessName(getBusinessName(genTable.getTableName()));
        genTable.setFunctionName(replaceText(genTable.getTableComment()));
        genTable.setFunctionAuthor(GeneratorConfig.getAuthor());
